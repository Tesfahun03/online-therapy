  ...
  const handelSendMessageSubmit = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setModalMessage(
          "Thank you for your feedback. We will get back to you soon, BunnaMind"
        );
        setShowModal(true);
      } else {
        setModalVariant("danger");
        setModalMessage("Your message is not received. Please try again.");
        setShowModal(true);
      }
    } catch (error) {
      setModalVariant("danger");
    ...
    <>
      ...
      <div className="Home" id="Home">
        <div className="Home-img">
          <img
            src="../Images/home/EllipseTalk.png"
            alt=""
            className="ellipsetalk"
          />
        </div>
        <div className="Home-Intro-Title">
          ...
          <Link to="/login-p">
            <button>{t("home.homeGetStartedButton")}</button>
          </Link>
        </div>
      </div>
      ...
      <div className="AboutUs" id="AboutUs">
          ...
          <div className="About-why">
            ...
            <div className="why-even">
              ...
              <div className="why-reason-desc">
                ...
                <h4 className="description">
                  {t("home.homeAboutUsDescription1")}
                </h4>
              </div>
            </div>
            <div className="why-odd">
              ...
              <div className="why-reason-desc">
                ...
                <h4 className="description">
                  {t("home.homeAboutUsDescription2")}
                </h4>
              </div>
            </div>
            <div className="why-even">
              ...
              <div className="why-reason-desc">
                ...
                <h4 className="description">
                  {t("home.homeAboutUsDescription3")}
                </h4>
              </div>
            </div>
            <div className="why-odd">
              ...
              <div className="why-reason-desc">
                ...
                <h4 className="description">
                  {t("home.homeAboutUsDescription4")}
                </h4>
              </div>
            </div>
          </div>
        ...
        <div className="AboutUs-img">
          <img
            src="../Images/home/PeopleBean.png"
            alt=""
      ...
      <Modal show={showModal} onHide={handleCloseModal} variant={modalVariant} centered>
