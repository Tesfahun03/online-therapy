                ...
                <form onSubmit={handleRegisterTherapistSubmit} encType="multipart/form-data" >
                    ...
                    <div className="form-outline d-flex">
                        <select
                            ...
                            onChange={handleRegisterTherapistData}
                        >
                            <option value="" className="SelectOptionDefault">{t("register.registerGender")}</option>
                    ...
                    <div className="form-outline d-flex">
                        <select
                            ...
                            onChange={handleRegisterTherapistData}
                        >
                            <option value="" className="SelectOptionDefault">{t("register.registerMartialStatus")}</option>
                        ...
                        <select
                            ...
                            onChange={handleRegisterTherapistData}
                        >
                            <option value="" className="SelectOptionDefault">{t("register.registerLanguagePreference")}</option>
                            <option value="AMHARIC" >Amharic</option>
                    ...
                    <div className="form-outline d-flex">
                        ...
                        <select
                            ...
                            onChange={handleRegisterTherapistData}
                        >
                            <option value="" className="SelectOptionDefault" >{t("register.registerReligion")}</option>
                    ...
                    <div className="form-outline">
                            <label htmlFor="fileInput" className="text-left">{t("register.registerLabelLiscence")}</label>
                            <input
                                type="file"
                                id="fileInput"
                                className="form-control"
                    ...
                    <Link to="" style={{textDecoration:"none"}}><p>{t("register.registerForgetPassword")}</p></Link>
                    <p>{t("register.registerHaveAccount")} <Link to="/login-d" style={{textDecoration:'none'}}>Sign in</Link></p>
                </form>
            </div>
        </div>
        </div>
