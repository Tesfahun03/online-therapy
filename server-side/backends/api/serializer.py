...
class ProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Profile
        fields = ['user', 'user_id', 'user_type','first_name', 'last_name', 'image', 'bio', 'prefered_language', "age", 'gender', 'martial_status', 'phone', 'city', 'region' ]
...
class TherapistSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Therapist
        fields =['profile', 'specialization', 'experience', 'licenses', 'religion', 'paymentRate', 'totalBalance', 'withdrawableBalance']
