...
from .serializer import ChapaTransactionSerializer
from api.models import Patient, Profile, Therapist, User
    ...
    def get(self, request, tx_ref):
        ...
        try:
            ...
            if response.status_code == 200:
                ...
                therapistContent = f"{patients.username} has made a payment of amount {transaction.amount} ETB for a therapy session with you."
                patientContent = f"You have successfully made an payment of amount {transaction.amount} ETB for a therapy session with {therapists.username}. Now, you can schedule an appoinment."
