...
from api.models import Therapist, User, Profile, Patient
...
class TherapistAvailabilitySerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = ['id', 'therapist','therapistID', 'therapist_first_name', 'therapist_last_name', 'date', 'start_time', 'end_time']
...
class AppointmentsSerializer(serializers.ModelSerializer):
    ...
    date_available = serializers.PrimaryKeyRelatedField(queryset=TherapistAvailability.objects.all(), write_only=True)
    ...
    class Meta:
        model = Appointments
        fields = ['id', 'patient', 'date_available','date','start_time','end_time','therapist_first_name','therapist_last_name','therapistID','patient_first_name','patient_last_name','patientID', 'room', 'host','meeting_id', 'roomName', 'startDate', 'endDate']
